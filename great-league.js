...
export const sets = [
  ...
  // [
  //   // Jan 23rd - Set 1
  //   ["Marowak (Alolan)", "Azumarill", "Melmetal"],
  //   ["Ninetales (Alolan)", "Jellicent", "Medicham"],
  //   ["Mawile (Shadow)", "Skuntank (Shadow)", "Greedent"],
  //   ["Talonflame", "Ferrothorn", "Scrafty"],
  //   ["Medicham", "Nidoqueen", "Scrafty"],
  // ], // 3-2
  // [
  //   // Jan 23rd - Set 2
  //   ["Talonflame", "Venusaur", "Swampert"],
  //   ["Dewgong", "Meganium", "Medicham"],
  //   ["Scrafty", "Walrein", "Seviper"],
  //   ["Skarmory", "Hypno (Shadow)", "Swampert (Shadow)"],
  //   ["Umbreon", "Toxicroak", "Bastiodon"],
  // ], // 4-1
  // [
  //   // Jan 23rd - Set 3
  //   ["Skarmory", "Vigoroth", "Medicham"],
  //   ["Machamp (Shadow)", "Hypno (Shadow)", "Victreebel (Shadow)"],
  //   ["Umbreon", "Skarmory", "Venusaur"],
  //   ["Jellicent", "Altaria", "Greedent"],
  //   ["Deoxys (Defense)", "Toxicroak", "Scrafty"],
  // ], // 3-2
  // [
  //   // Jan 23th - Set 4
  //   ["Umbreon", "Nidoqueen"],
  //   ["Pelipper", "Cresselia", "Talonflame"],
  //   ["Skuntank (Shadow)", "Jellicent", "Machamp"],
  //   ["Wigglytuff", "Victreebel (Shadow)", "Mawile (Shadow)"],
  //   ["Scrafty", "Skarmory", "Azumarill"],
  // ], // 4-1
  // [
  //   // Jan 23th - Set 5
  //   ["Swampert", "Sableye", "Talonflame"],
  //   ["Walrein", "Hypno", "Machamp (Shadow)"],
  //   ["Umbreon", "Serperior", "Pidgeot"],
  //   ["Altaria", "Victreebel (Shadow)"],
  //   ["Whiscash", "Venusaur", "Umbreon"],
  // ], // 3-2
  // [
  //   // Jan 23th - Set 6
  //   ["Skarmory", "Jellicent", "Trevenant"],
  //   ["Bastiodon", "Sableye", "Medicham"],
  //   ["Jellicent", "Venusaur", "Skarmory"],
  //   ["Mew", "Trevenant", "Ninetales (Alolan)"],
  //   ["Galvantula", "Trevenant", "Sirfetch'd"],
  // ], // 1-4
  // [
  //   // Jan 23th - Set 7
  //   ["Stunfisk (Galarian)", "Trevenant", "Azumarill"],
  //   ["Jellicent", "Altaria", "Stunfisk (Galarian)"],
  //   ["Nidoqueen", "Obstagoon", "Skarmory"],
  //   ["Nidoqueen", "Ninetales (Alolan)", "Medicham"],
  //   ["Wigglytuff", "Toxicroak", "Talonflame"],
  // ], // 3-2
  // [
  //   // Jan 23th - Set 8
  //   ["Medicham", "Sableye", "Bastiodon"],
  //   ["Medicham", "Bastiodon", "Skarmory"],
  //   ["Bastiodon", "Vigoroth", "Medicham"],
  //   ["Venusaur", "Stunfisk (Galarian)", "Froslass"],
  //   ["Galvantula", "Ninetales (Alolan)", "Medicham"],
  // ], // 4-1
  // [
  //   // Jan 23th - Set 9
  //   ["Umbreon", "Bastiodon", "Granbull (Shadow)"],
  //   ["Ninetales (Alolan)", "Umbreon", "Medicham"],
  //   ["Talonflame", "Swampert", "Venusaur"],
  //   ["Nidoqueen", "Greedent", "Walrein"],
  //   ["Jellicent", "Scrafty", "Pidgeot"],
  // ], // 1-3-1
  // [
  //   // Jan 23th - Set 10
  //   ["Altaria", "Bronzong", "Walrein"],
  //   ["Azumarill", "Venusaur (Shadow)", "Stunfisk (Galarian)"],
  //   ["Deoxys (Defense)", "Galvantula", "Walrein"],
  //   ["Altaria", "Azumarill", "Registeel"],
  //   ["Venusaur", "Marowak (Alolan)", "Azumarill"],
  // ], // 3-2
  // [
  //   // Jan 23th - Set 11
  //   ["Stunfisk (Galarian)", "Azumarill", "Altaria"],
  //   ["Granbull (Shadow)", "Vileplume (Shadow)", "Victreebel (Shadow)"],
  //   ["Walrein", "Pelipper", "Talonflame"],
  //   ["Machamp (Shadow)", "Ninetales (Alolan)", "Granbull (Shadow)"],
  //   ["Altaria", "Ferrothorn", "Ninetales (Alolan)"],
  // ], // 2-3
  // [
  //   // Jan 23th - Set 12
  //   ["Talonflame", "Ferrothorn", "Swampert (Shadow)"],
  //   ["Azumarill", "Greedent", "Medicham"],
  //   ["Azumarill", "Deoxys (Defense)", "Walrein"],
  //   ["Froslass", "Venusaur", "Zapdos (Shadow)"],
  //   ["Stunfisk", "Venusaur", "Talonflame"],
  // ], // 3-2
  // [
  //   // Jan 23th - Set 13
  //   ["Trevenant", "Azumarill", "Stunfisk (Galarian)"],
  //   ["Azumarill", "Skarmory", "Sableye"],
  //   ["Venusaur", "Talonflame", "Walrein"],
  //   ["Stunfisk (Galarian)", "Venusaur (Shadow)", "Pelipper"],
  //   ["Azumarill", "Venusaur", "Dragonair"],
  // ], // 1-4
  // [
  //   // Jan 23th - Set 14
  //   ["Bastiodon", "Meganium", "Azumarill"],
  //   ["Medicham", "Venusaur", "Bastiodon"],
  //   ["Altaria", "Registeel", "Jellicent"],
  //   ["Stunfisk (Galarian)", "Talonflame", "Walrein"],
  //   ["Nidoqueen (Shadow)", "Deoxys (Defense)", "Abomasnow"],
  // ], // 4-1
  // [
  //   // Jan 23th - Set 15
  //   ["Stunfisk (Galarian)", "Venusaur", "Deoxys (Defense)"],
  //   ["Nidoqueen (Shadow)", "Blaziken", "Stunfisk"],
  //   ["Stunfisk (Galarian)", "Talonflame", "Walrein"],
  //   ["Venusaur", "Bastiodon", "Azumarill"],
  //   ["Skarmory", "Sirfetch'd", "Hypno"],
  // ], // 4-1
  // [
  //   // Jan 23th - Set 16
  //   ["Trevenant", "Azumarill", "Skarmory"],
  //   ["Skarmory", "Azumarill", "Swampert"],
  //   ["Drifblim", "Whiscash", "Venusaur"],
  //   ["Ninetales (Alolan)", "Trevenant", "Swampert"],
  //   ["Skarmory", "Meganium", "Shiftry"],
  // ], // 4-1
  // [
  //   // Jan 23th - Set 17
  //   ["Swampert", "Skarmory", "Sirfetch'd"],
  //   ["Umbreon", "Skarmory", "Venusaur"],
  //   ["Scrafty", "Galvantula", "Walrein"],
  //   ["Stunfisk (Galarian)", "Azumarill", "Trevenant"],
  //   ["Nidoqueen (Shadow)", "Stunfisk (Galarian)", "Walrein"],
  // ], // 2-3
  // [
  //   // Jan 23th - Set 18
  //   ["Trevenant", "Azumarill", "Stunfisk (Galarian)"],
  //   ["Sableye", "Nidoqueen (Shadow)", "Venusaur"],
  //   ["Ferrothorn", "Azumarill", "Swampert"],
  //   ["Scrafty", "Nidoqueen (Shadow)", "Skarmory"],
  //   ["Ninetales (Alolan)", "Medicham", "Walrein"],
  // ], // 3-2
  // [
  //   // Jan 23th - Set 19
  //   ["Stunfisk", "Walrein", "Skarmory"],
  //   ["Deoxys (Defense)", "Mandibuzz", "Ferrothorn"],
  //   ["Trevenant", "Nidoqueen (Shadow)", "Stunfisk (Galarian)"],
  //   ["Azumarill", "Ferrothorn", "Froslass"],
  //   ["Skarmory", "Vigoroth", "Scrafty"],
  // ], // 4-1
  // [
  //   // Jan 23th - Set 20
  //   ["Talonflame", "Venusaur", "Politoed"],
  //   ["Stunfisk (Galarian)", "Trevenant", "Azumarill"],
  //   ["Stunfisk", "Deoxys (Defense)", "Wigglytuff"],
  //   ["Stunfisk", "Skarmory", "Umbreon"],
  //   ["Talonflame", "Medicham", "Trevenant"],
  // ], // 5-0
  // [
  //   // Jan 24th - Set 1
  //   ["Talonflame", "Stunfisk (Galarian)", "Politoed (Shadow)"],
  //   ["Walrein", "Nidoqueen", "Medicham"],
  //   ["Victreebel (Shadow)", "Vigoroth", "Bastiodon"],
  //   ["Stunfisk (Galarian)", "Ninetales (Alolan)", "Talonflame"],
  //   ["Primeape", "Nidoqueen", "Walrein"],
  // ], // 4-1
  // [
  //   // Jan 24th - Set 2
  //   ["Marowak (Alolan)", "Azumarill", "Altaria"],
  //   ["Sableye", "Azumarill", "Nidoqueen"],
  //   ["Talonflame", "Stunfisk", "Swampert"],
  //   ["Cofagrigus", "Azumarill", "Lickitung"],
  //   ["Talonflame", "Walrein", "Sableye"],
  // ], // 3-2
  // [
  //   // Jan 24th - Set 3
  //   ["Deoxys (Defense)", "Ninetales (Alolan)", "Sylveon"],
  //   ["Scrafty", "Cofagrigus", "Jellicent"],
  //   ["Galvantula", "Medicham", "Sableye"],
  //   ["Bastiodon", "Serperior", "Venusaur (Shadow)"],
  //   ["Victreebel (Shadow)", "Bastiodon", "Walrein"],
  // ],
  [
    // Feb 22nd - Set 1
    [],
